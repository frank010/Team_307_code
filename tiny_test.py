#The source of this code comes from the file openvino_tiny-yolov3_test.py which comes from the OpenVINO-YoloV3 repo made by PINTO0309
#Changes were made to classes coords and num to accomodate the new trained wieghts
#openCV function cv2.imwrite was used to save the frames with identified objects to the targets folder in the drone pi Desktop
#Francisco Silva
#Matthew Roberts
#Team_307
#4/26/2019
...
# Matthew's variables
image_path = "/home/pi/Desktop/targets/"
...
def main_IE_infer():
    ...
    model_xml = "tiny_yolov3_person.xml" #<--- MYRIAD
    model_bin = "tiny_yolov3_person.bin"
    ...
    while cap.isOpened():
        ...
        for obj in objects:
            ...
            cv2.imwrite(os.path.join(image_path + "Target_" + str(name_counter) + ".png"), image, [int(cv2.IMWRITE_PNG_COMPRESSION), 9])
            name_counter += 1
